...
func TestCurrencyUnits(t *testing.T) {
	tests := []struct {
		...
		{"100000000000000", "1 pS"},
		{"123456000000000", "1.235 pS"},
		{"1234560000000000", "12.35 pS"},
		{"12345600000000000", "123.5 pS"},
		{"100000000000000000", "1 nS"},
		{"100000000000000000000", "1 uS"},
		{"100000000000000000000000", "1 mS"},
		{"100000000000000000000000000", "1 SCP"},
		{"100000000000000000000000000000", "1 KS"},
		{"100000000000000000000000000000000", "1 MS"},
		{"100000000000000000000000000000000000", "1 GS"},
		{"100000000000000000000000000000000000000", "1 TS"},
		{"123456000000000000000000000000000000000", "1.235 TS"},
		{"123456000000000000000000000000000000000000", "1235 TS"},
	}
	for _, test := range tests {
