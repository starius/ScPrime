...
// minerstartcmd is the handler for the command `spc stratum-miner start`.
...
// stratumminerstopcmd is the handler for the command `spc stratum-miner stop`.
...
// stratumminercmd is the handler for the command `spc stratum-miner`.
