...
the rules for standard ScPrime transactions.
...
protocols sit on top of ScPrime. The arbitrary data can also be used for soft
...
indicates that the remaining data has no relevance to ScPrime protocol rules, and
never will.
