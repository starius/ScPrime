...
the rest of SiaPrime. It also provides endpoints for viewing build constants.
...
```javascript
{
  // Version number of the running SiaPrime Daemon. This number is visible to its
