...
```javascript
{
    ...
    // port SiaPrime is listening on. It represents a `modules.NetAddress`.
    "netaddress": String,
...
```json
{
    "netaddress":"333.333.333.333:4281",
    "peers":[
        {
            "netaddress":"222.222.222.222:4281",
            "version":"1.0.0",
            "inbound":false
        },
        {
            "netaddress":"111.111.111.111:4281",
            "version":"0.6.0",
            "inbound":true
        }
    ]
