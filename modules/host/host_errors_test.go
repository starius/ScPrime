...
func TestHostFailedMkdirAll(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrMkdirAll{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, "127.0.0.1:0", filepath.Join(ht.persistDir, modules.HostDir), nil, 5*time.Second)
...
func TestHostFailedNewLogger(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrNewLogger{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, "127.0.0.1:0", filepath.Join(ht.persistDir, modules.HostDir), nil, 5*time.Second)
...
func TestHostFailedOpenDatabase(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrOpenDatabase{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, "127.0.0.1:0", filepath.Join(ht.persistDir, modules.HostDir), nil, 5*time.Second)
...
func TestHostFailedLoadFile(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrLoadFile{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, "127.0.0.1:0", filepath.Join(ht.persistDir, modules.HostDir), nil, 5*time.Second)
...
func TestHostFailedListen(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrListen{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, "127.0.0.1:0", filepath.Join(ht.persistDir, modules.HostDir), nil, 5*time.Second)
