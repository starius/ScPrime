...
func TestHostFailedMkdirAll(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrMkdirAll{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
	...
	// operation will fail.
	ht.host, err = NewCustomHost(modules.ProdDependencies, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestHostFailedNewLogger(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrNewLogger{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
...
func TestHostFailedOpenDatabase(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrOpenDatabase{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
...
func TestHostFailedLoadFile(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrLoadFile{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
...
func TestHostFailedListen(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrListen{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.mux, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir), ":0", 5*time.Second)
